...
load('data');
%% 1) PID del sistema válvula reactor
k_ap = 0.003731;
tau_ap = 100;
tita_ap = 30;
...
title('Sistema válvula-reactor real y modelado frente a escalón de +4% SP(Ap)');
...
title('Válvula real vs modelada frente a escalón del 4% en %Ap');
legend('Real','Modelada');
xlabel('Tiempo [s]');
ylabel('Fh');
grid on;
...
%% 3) Diseño del controlador PI para la válvula
...
%% 6,7) Comparación de los métodos  frente a Dfh
% La perturbación del principio parece ser producida por un leve error 
% en los parámetros de equilibrio, por eso meto el escalón pasado ese
% transitorio
...
grid on;
title('Respuesta de controladores frente a perturbación de +1% Fh en Dfh');
